    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
                ...
                <h2 className="mt-4 text-3xl font-extrabold text-gray-900 tracking-tight">Register as Receiver</h2>
                <p className="mt-2 text-sm text-gray-500">Find compatible blood samples near you</p>
            </div>
                ...
                <div className="bg-white py-8 px-6 shadow-xl shadow-red-100/50 rounded-2xl sm:px-10 border border-gray-100">
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <select name="blood_group" value={formData.blood_group} onChange={handleChange} required className="block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm bg-white focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 sm:text-sm">
                    ...
                    <div className="mt-6 text-center text-sm text-gray-600 space-y-1">
                        ...
                        <p>Are you a Hospital? <Link to="/register/hospital" className="font-medium text-red-600 hover:text-red-500">Register here</Link></p>
                    </div>
                </div>
            </div>
        </div>
